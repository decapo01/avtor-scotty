...
signUpFormView signUpForm errors =
  div ! class_ "container" $ do
    form ! method "POST" $ do
      ...
      passwordInput "Password" "signUpForm.password" (attrFromText (password signUpForm)) (passwordErrors errors)
      passwordInput "Confirm Password" "signUpForm.confirmPassword" (attrFromText (confirmPassword signUpForm)) (confirmPasswordErrors errors)
